...
- epDiscordBot: discord bot that shows database runs and levels (requires [discord.py](https://pypi.org/project/discord.py/), [requests](https://pypi.org/project/requests/), [feedparser](https://pypi.org/project/feedparser/), [Wand](https://pypi.org/project/Wand/), and [ImageMagick](https://imagemagick.org/))
- epBingoBot: discord bot that runs team-based bingo gamemode using database levels (requires [discord.py](https://pypi.org/project/discord.py/), [requests](https://pypi.org/project/requests/), [pillow](https://pypi.org/project/pillow/), [Wand](https://pypi.org/project/Wand/), and [ImageMagick](https://imagemagick.org/))
